...
func _init() -> void:
	...
	# Renamed from the placeholder "Third" -- see character_visual.gd's
	# CHARACTER_DATA. Coordinates are the expanded world's chalk circle at
	# (0,-11), not the old cramped courtyard's (0,-3.8).
	_npc(npcs_container, root, character_visual_packed, "Priya", 1.45, -10.75, -0.4)
